...
tf.flags.DEFINE_string("input_file", './data/faq_seg.txt', "Input file (default: ./data/train.pos)")
...
tf.flags.DEFINE_integer("num_classes", 54, "Number of labels (default: 54)")
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        out_dir = os.path.abspath(os.path.join(os.path.curdir, "save", timestamp))
        print("Writing to {}\n".format(out_dir))
